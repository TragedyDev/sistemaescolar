                ...
                <div class="col-md-12">
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Permisos Registradas</h3>
                            <div class="card-tools">
                                <a href="create_permisos.php" class="btn btn-primary"><i class="bi bi-plus-square"></i> Crear Permiso</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <table id="example1" class="table table-striped table-bordered table-hover table-sm">
                                ...
                                <tr>
                                    ...
                                    <th><center>Nombre de URL</center></th>
                            ...
                            <tr>
                              ...
                              <td style="text-align: center"><?=$permiso['nombre_url'];?></td>
                              <td style="text-align: center"><?=$permiso['url'];?></td>
